...
<footer class=" bg-black">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="http://localhost:3000" class="flex items-center">
                  <img src={logo} class="h-8 me-3" alt="atlas LOGO" />
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="https://github.com/IAMTHEWONDERER" class="hover:underline ">Github</a>
                      </li>
                      <li class="mb-4">
              ...
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      ...
                      <li class="mb-4">
                          <a href="#" class="hover:underline">General Info</a>
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">ATLAS © 2024. All Rights Reserved.
          </span>
