...
const UserDashboard = () => {
    ...
    const handleBookNow = async (coachId) => {
        try {
            ...
            const coachId = "664a3d847471c32ecf7d7588";
            const response = await fetch(`http://localhost:3111/api/postbooking/${coachId}`, {
            method: 'POST',
            headers: {
            ...
            body: JSON.stringify({
              session_type: coachId.availability,
            }),
          });
    ...
    <main className="flex flex-col items-center justify-center min-h-screen bg-gray-100 py-12 md:py-24 lg:py-32">
      <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-1">
                ...
                <StarIcon className="w-6 h-6 fill-yellow-400" />
                <StarIcon className="w-6 h-6 fill-yellow-400" />
                <StarIcon className="w-6 h-6 fill-gray-400" />
                <StarIcon className="w-6 h-6 fill-gray-400" />
              </div>
        ...
        <button
            ...
            onClick={() => handleBookNow(coachId)} // Pass coachId when button clicked
            >
            Book Now
        </button>
            </div>
